I developed a C++ compiler utilizing Flex, Bison, C++, and Yacc for lexical analysis, syntax parsing, and code generation as a part of my university assignment in the Compiler course.
...
___
I managed to make a fully functional C++ compiler that was able to compile even some of the more complex codes like recursion.
